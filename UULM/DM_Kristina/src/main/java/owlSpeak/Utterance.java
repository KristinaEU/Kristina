...
public class Utterance extends GenericClass{
	...
	/**
     * returns the gender of the Utterance.
     * @return the gender of the Utterance.
     */
    public String getSpeakerGender(){
    	return GenericProvider.getStringData(indi, GenericProvider.speakerGenderProp, onto, factory);
    }
    /**
     * returns true if the gender field contains a number. 
     * @return true if gender is not empty.
     */
    public boolean hasSpeakerGender(){
    	return GenericProvider.hasDataProperty(indi, GenericProvider.speakerGenderProp, onto, factory);
    }
    /**
     * removes the gender of the Utterance.
     * @param oldGender the new gender of the Utterance.
     */
    public void removeSpeakerGender(String oldGender){
    	GenericProvider.removeStringData(indi, oldGender, GenericProvider.speakerGenderProp, onto, factory, manager);	
    }
    /**
     * sets the gender of the Utterance to the specified value (male|female).
     * @param oldGender the current gender.
     * @param newGender the new gender of the Utterance.
     */    
    public void setSpeakerGender(String oldGender, String newGender){
    	removeVolume(oldGender);
    	GenericProvider.addStringData(indi, newGender, GenericProvider.speakerGenderProp, onto, factory, manager);
    }
}