...
public class KristinaTest {
	...
	public static void main(String[] args) throws IOException{
		...
		KristinaDocument systemMove = (KristinaDocument) (OwlSpeakServlet.processRequest(whereAmI, null, user, "0", owlEngine));
		...
		systemMove = (KristinaDocument) (OwlSpeakServlet.processWork(whereAmI, agenda, "usermov_Greet", confidence, "Hallo", user, owlEngine)); 
