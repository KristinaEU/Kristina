...
public class GroupAffectMonitorPanel extends JPanel {
  ...
  private Hashtable<String, MoodCube> groupToMoodDisplay =
  ...
  public GroupAffectMonitorPanel(String group, EmotionVector vec, Mood currentMood,
    ...
    MoodCube moodDisplay = new MoodCube(group, moodCubePanel);
    moodDisplay.init();
  ...
  public void updateMoodDisplay(String group, EmotionVector emotions,
    ...
    if (fIsReady) {
      ...
      MoodCube moodDisplay = groupToMoodDisplay.get(group);
      if (moodDisplay != null) {
