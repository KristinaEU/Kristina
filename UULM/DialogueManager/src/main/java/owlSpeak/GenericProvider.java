...
public class GenericProvider {
	...
	/**
	 * KRISTINA specific property
	 */
	public static final String dialogueActionProp = "#dialogueAction";
	public static final String ageProp = "#age";
	public static final String isLastUserMoveProp = "#isLastUserMove";
	public static final String cannedTextProp = "#cannedText";
	public static final String nonPersistentProp = "#nonPersistent";
	 ...
	 * @param onto the ontology the individuals are part of.
	 * @param factory the factory that should be used.
     * @return the int value of the property or 420 in all other cases (e.g., undefined).
     */
	...
	public static String getStringData(OWLIndividual owlIndi, String property, OWLOntology onto, OWLDataFactory factory){
		OWLDataProperty p = factory.getOWLDataProperty(IRI.create(Settings.uri+property));
		Set<OWLLiteral> o = owlIndi.getDataPropertyValues(p, onto);
		if(!o.isEmpty()){
			return  o.iterator().next().getLiteral();
		}
		return null;
	}
    /**
