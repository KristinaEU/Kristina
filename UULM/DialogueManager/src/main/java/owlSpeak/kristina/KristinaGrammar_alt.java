...
public class KristinaGrammar_alt implements IGrammar {
	//Externe Grammatiken und Variablen werden noch nicht unterst�tzt
...
//		System.out.println("buildGrammar SRGS: Element" + element + "Vector: " + grammar);
	...
	// leicht um�ndern!!! Grammatik Teil anpassen, sonst wie JSGF
	@Override
