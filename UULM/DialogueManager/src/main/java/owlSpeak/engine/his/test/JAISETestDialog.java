...
public class JAISETestDialog {
	...
	public static void main(String[] args) {
		...
		String[] conList1 = {"0.89","0.1",null};
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "ask_dest_agenda", "user", resList1, "2", conList1, spkList1);
		...
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "ask_iss_agenda", "user", resList30, "1", conList30, spkList30);
		String[] resList31 = {"heating_a1n1d_user_heating_temp_20_mv","heating_a1n1d_user_heating_temp_24_mv",null};
		String[] spkList31 = {"20 degrees","24 degrees",null};
		String[] conList31 = {"0.89","0.05",null};
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "heating_which_temp_agenda", "user", resList31, "2", conList31, spkList31);
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "heating_on_and_temp_agenda", "user", resList0, null , conList0, spkList0);
		...
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "ask_iss_agenda", "user", resList5, "2", conList5, spkList5);
		String[] resList6 = {"travel_a1n1d_reject_iss_mv",null,null};
		String[] spkList6 = {"nein",null,null};
		String[] conList6 = {"0.78",null,null};
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "ask_dur_impl_iss_agenda", "user", resList6, "1", conList6, spkList6);
		String[] resList7 = {"travel_a1n1d_iss_shopping_mv",null, null};
		String[] spkList7 = {"shopping",null,null};
		String[] conList7 = {"0.63",null,null};
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "ask_iss_agenda", "user", resList7, "1", conList7, spkList7);
		...
		owlEngine.buildWork("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "ask_dur_impl_iss_agenda", "user", resList8, "1", conList8, spkList8);
		owlEngine.buildRequest("http://penguin.e-technik.uni-ulm.de:8080/owlSpeak", "user", null, null, true);
