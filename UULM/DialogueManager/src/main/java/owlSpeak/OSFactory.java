...
//		}
	...
	/**
	 * returns the OWLClass of the Class KristinaMove.
	 * 
	 * @return the Class of the Class KristinaMove.
	 */
	public OWLClass getKristinaMoveClass() {
		return factory.getOWLClass(IRI.create(Settings.uri + "#"+KristinaMove.name));
	}

	/**
	 * creates a KristinaMove object.
	 * 
	 * @param name
	 *            the name of the Object to create.
	 * @return the created KristinaMove object.
	 */
	public KristinaMove createKristinaMove(String name) {
		OWLIndividual newIndi = factory.getOWLNamedIndividual(IRI.create(onto
				.getOntologyID().getOntologyIRI() + "#" + name));
		manager.applyChange(new AddAxiom(onto, factory
				.getOWLClassAssertionAxiom(getKristinaMoveClass(), newIndi)));
		return new KristinaMove(newIndi, onto, factory, manager);
	}

	/**
	 * returns a KristinaMove specified by its name.
	 * 
	 * @param name
	 *            the Name of the KristinaMove.
	 * @return the KristinaMove object.
	 */
	public KristinaMove getKristinaMove(String name) {
		OWLIndividual newIndi = factory.getOWLNamedIndividual(IRI.create(onto
				.getOntologyID().getOntologyIRI() + "#" + name));
		return new KristinaMove(newIndi, onto, factory, manager);
	}
	...
	/**
	 * returns a Collection of all KristinaMove objects.
	 * 
	 * @return the Collection of the KristinaMoves.
	 */
	public Collection<KristinaMove> getAllKristinaMoveInstances() {
		Iterator<OWLIndividual> coll = getKristinaMoveClass().getIndividuals(onto)
				.iterator();
		Collection<KristinaMove> moveColl = new ArrayList<KristinaMove>();
		while (coll.hasNext()) {
			moveColl.add(new KristinaMove(coll.next(), onto, factory, manager));
		}
		return moveColl;
	}
	
	/**
	 * removes a KristinaMove object.
	 * 
	 * @param agenda
	 *            the KristinaMove to remove.
	 */
	public void removeKristinaMove(KristinaMove move) {
		for(OWLAxiom a :onto.getAxioms()){
			if(a.getIndividualsInSignature().contains(move.indi)){
				manager.removeAxiom(onto, a);
			}
		}
	}
	...
	/**
	 * creates a SummaryAgenda object.
	 * 
	 * @param name
	 *            the name of the Object to create.
	 * @return the created SummaryAgenda object.
	 */
	...
	/**
	 * returns a SummaryAgenda specified by its name.
	 * 
	 * @param name
	 *            the Name of the SummaryAgenda.
	 * @return the SummaryAgenda object.
	 */
	public SummaryAgenda getSummaryAgenda(String name) {
		OWLIndividual newIndi = factory.getOWLNamedIndividual(IRI.create(onto
				.getOntologyID().getOntologyIRI() + "#" + name));
		return new SummaryAgenda(newIndi, onto, factory, manager);
	}
	...
	/**
	 * returns a Collection of all SummaryAgenda objects.
	 * 
	 * @return the Collection of the SummaryAgendas.
	 */
	...
	/**
	 * returns the OWLClass of the Class KristinaAgenda.
	 * 
	 * @return the Class of the Class KristinaAgenda.
	 */
	public OWLClass getKristinaAgendaClass() {
		return factory.getOWLClass(IRI.create(Settings.uri + "#"+KristinaAgenda.name));
	}
	
	/**
	 * creates a KristinaAgenda object.
	 * 
	 * @param name
	 *            the name of the Object to create.
	 * @return the created KristinaAgenda object.
	 */
	public KristinaAgenda createKristinaAgenda(String name) {
		OWLIndividual newIndi = factory.getOWLNamedIndividual(IRI.create(onto
				.getOntologyID().getOntologyIRI() + "#" + name));
		manager.applyChange(new AddAxiom(onto, factory
				.getOWLClassAssertionAxiom(getKristinaAgendaClass(), newIndi)));
		return new KristinaAgenda(newIndi, onto, factory, manager);
	}
	
	/**
	 * returns a KristinaAgenda specified by its name.
	 * 
	 * @param name
	 *            the Name of the KristinaAgenda.
	 * @return the KristinaAgenda object.
	 */
	public KristinaAgenda getKristinaAgenda(String name) {
		OWLIndividual newIndi = factory.getOWLNamedIndividual(IRI.create(onto
				.getOntologyID().getOntologyIRI() + "#" + name));
		return new KristinaAgenda(newIndi, onto, factory, manager);
	}
	...
	/**
	 * returns a Collection of all KristinaAgenda objects.
	 * 
	 * @return the Collection of the KristinaAgendas.
	 */
	public Collection<KristinaAgenda> getAllKristinaAgendaInstances() {
		Iterator<OWLIndividual> coll = getKristinaAgendaClass().getIndividuals(onto)
				.iterator();
		Collection<KristinaAgenda> agendaColl = new ArrayList<KristinaAgenda>();
		while (coll.hasNext()) {
			agendaColl.add(new KristinaAgenda(coll.next(), onto, factory, manager));
		}
		return agendaColl;
	}
	
	/**
	 * removes a KristinaAgenda object.
	 * 
	 * @param agenda
	 *            the KristinaAgenda to remove.
	 */
	public void removeKristinaAgenda(KristinaAgenda agenda) {
		for(OWLAxiom a :onto.getAxioms()){
			if(a.getIndividualsInSignature().contains(agenda.indi)){
				manager.removeAxiom(onto, a);
			}
		}
	}
	...
	/**
	 * creates a SummaryBelief object.
	 * 
	 * @param name
	 *            the name of the Object to create.
	 * @return the created SummaryBelief object.
	 */
