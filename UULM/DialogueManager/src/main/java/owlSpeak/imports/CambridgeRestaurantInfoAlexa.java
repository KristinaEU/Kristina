...
public class CambridgeRestaurantInfoAlexa {
	...
	public static Grammar prefixGrammarArea (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna) [eat] [something]] in the","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarFood (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna) [eat] [something] [some] | (It | The food) (should | needs to | has to) be","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarName (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna)] [eat] [something] in the restaurant | The name [of the restaurant is] | Its name is","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarPricerange (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna) [eat] [something] | (It | The restaurant) (should | needs to | hast to) be","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarRequestAddressName (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna | What is | What's) [have] the address of the restaurant","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarRequestPhoneName (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna | What is | What's) [have] the phone number of the restaurant","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarRequestPostcodeName (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna | What is | What's) [have] the postcode of the restaurant","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarRequestSignatureName (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(I want [to] | I would like [to] | I'd like [to] | I need [to] | I wanna | What is | What's) [have] the signature of the restaurant","en"));
		return g;
	}
	...
	public static Grammar prefixGrammarRequestPricerangeName (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(What's | What is) the pricerange of the restaurant","en"));
		return g;
	}
	...
	public static Grammar grammarBye (OSFactory factory){
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[(Thanks | Thank you)] (Goodbye | Bye)","en"));
		return g;
	}
