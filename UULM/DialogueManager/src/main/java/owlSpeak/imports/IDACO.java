...
/**
 * Class for the IDACO spoken language operation assistant
 * 
...
public class IDACO {
	...
	public static Grammar grammarExit (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("([Ich] [(möchte | würde)] [gerne] IDACO beenden | Lass uns die Unterhaltung beenden [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarAffirm (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("Ja [(bitte | genau)] | [(Sehr | Liebend)] gerne | Genau | [Das (ist | wär[e])] (richtig | korrekt | in Ordnung | okay | gut | super | toll | klasse | spitze | nicht schlecht)","de"));
		return g;
	}
	...
	public static Grammar grammarDeny (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(([(Nein | Ne | Nö)] [das ist] (falsch | nicht (richtig | korrekt))) | Nein [danke] | [Ich (will | möcht[e]) das] [bitte] nicht | Lass (es | das) [doch] [bitte] | (Da hast du mich | du hast mich [wohl | offenbar | scheinbar]) (falsch | nicht [richtig]) verstanden)","de"));
		return g;
	}
	...
	public static Grammar grammarTool (OSFactory factory, String longName, String shortName) {		
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[(Geben | Reichen | Könn[t]en) Sie mir] [bitte] [(Den | Die | Das | Ein[e[n]])] [(Erste | Zweite | Nächste)] " + longName + " [(reichen | geben)] [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarOneMore (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[(Noch | Nochmal)] ein[(s | e[n])] [mehr] [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarCorrectCntTo0 (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[Noch] [gar] (keins | keine[n])","de"));
		return g;
	}
	...
	public static Grammar grammarSetToN (OSFactory factory, int n) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [Stell (es | sie | ihn) [doch] [bitte]] [auf]" + n + "[(Zentimeter | Grad | mmHg | Prozent)] [bitte] [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarSettingsThermoflator (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] die (aktuellen | momentanen) Einstellungen für den (Thermoflator | [Gas]Insufflator) [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarSettingsRoomLight (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] die (aktuellen | momentanen) Einstellungen für das [Raum]Licht [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarSettingsEndomat (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] die (aktuellen | momentanen) Einstellungen für den Endomat [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarSettingsTable (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] die (aktuellen | momentanen) Einstellungen für den [OP]Tisch [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarPresetsThermoflator (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] (die | meine) (aktuellen | momentanen) Voreinstellungen für den (Thermoflator | [Gas]Insufflator) [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarPresetsRoomLight (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] (die | meine) (aktuellen | momentanen) Voreinstellungen für das [Raum]Licht [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarPresetsEndomat (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] (die | meine) (aktuellen | momentanen) Voreinstellungen für den Endomat [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarPresetsTable (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [(Wie sind [denn] | Sag mir doch)] [bitte] (die | meine) (aktuellen | momentanen) Voreinstellungen für den [OP]Tisch [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarChangePresetsThermoflator (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [Ich] (will | möchte | würde) [bitte] [gerne] [(die | meine)] Voreinstellungen für den (Thermoflator | [Gas]Insufflator) (ändern | neu einstellen | erneuern)","de"));
		return g;
	}
	...
	public static Grammar grammarChangePresetsRoomLight (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [Ich] (will | möchte | würde) [bitte] [gerne] [(die | meine)] Voreinstellungen für das [Raum]Licht (ändern | neu einstellen | erneuern)","de"));
		return g;
	}
	...
	public static Grammar grammarChangePresetsEndomat (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [Ich] (will | möchte | würde) [bitte] [gerne] [(die | meine)] Voreinstellungen für den Endomat (ändern | neu einstellen | erneuern)","de"));
		return g;
	}
	...
	public static Grammar grammarChangePresetsTable (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [Ich] (will | möchte | würde) [bitte] [gerne] [(die | meine)] Voreinstellungen für den [OP]Tisch (ändern | neu einstellen | erneuern)","de"));
		return g;
	}
	...
	public static Grammar grammarUndoStartGas (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Rückgängig [machen] | (Gas[fluss] | Insufflator | Thermoflator) [sofort] [wieder] (aus[(schalten | machen)] | stoppen) | [IDACO] (Schalt[e] | Mach) [doch] [bitte] (das Gas | den (Insufflator | Thermoflator)) [(schnell | sofort | gleich)] wieder aus [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarUndoMaxGas (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Rückgängig [machen] | (Gas[fluss] | Insufflator | Thermoflator) [sofort] [wieder] ([he]runter[(schalten | machen)] | langsamer | weniger) | [IDACO] (Schalt[e] | Mach) [doch] [bitte] (das Gas | den (Insufflator | Thermoflator)) [(schnell | sofort | gleich)] wieder [he]runter [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarUndoRoomLightOff (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Licht [sofort] [wieder] an | [IDACO] (Schalt[e] | Mach) [doch] [bitte] das [Raum]Licht [(schnell | sofort | gleich)] wieder (ein | an) [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarUndoRoomLightOn (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Rückgängig [machen] | Licht [sofort] [wieder] aus | [IDACO] (Schalt[e] | Mach) [doch] [bitte] das [Raum]Licht [(schnell | sofort | gleich)] wieder aus [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarUndoTableRevTrendLightOff (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Rückgängig [machen] | "
				...
				+ "[IDACO] (Stell | Dreh) [doch] [bitte] den [OP]Tisch [(schnell | sofort | gleich)] wieder (zurück | gerade | in die Ausgangsposition) und (schalt[e] | mach) [doch] [bitte] das [Raum]Licht [(schnell | sofort | gleich)] wieder (ein | an) [IDACO] | "
				+ "[Raum]Licht an[(machen|schalten)] und [OP]Tisch [sofort] [wieder] (zurück[(stellen|drehen)] | gerade | in die Ausgangsposition) | "
				+ "[IDACO] (Schalt[e] | mach) [doch] [bitte] das [Raum]Licht [(schnell | sofort | gleich)] wieder (ein | an) und (stell | dreh) [doch] [bitte] den [OP]Tisch [(schnell | sofort | gleich)] wieder (zurück | gerade | in die Ausgangsposition) [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarUndoTableRevTrend (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("([OP]Tisch [sofort] [wieder] (zurück[(stellen|drehen)] | gerade | in die Ausgangsposition) | [IDACO] (Stell | Dreh) [doch] [bitte] den [OP]Tisch [(schnell | sofort | gleich)] wieder (zurück | gerade | in die Ausgangsposition) [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarUndoTableUp (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Rückgängig [machen] | [OP]Tisch [sofort] [wieder] (zurück[(stellen|fahren)] | [he]runter | in die Ausgangsposition) | [IDACO] (Stell | Dreh) [doch] [bitte] den [OP]Tisch [(schnell | sofort | gleich)] wieder (zurück | [he]runter | in die Ausgangsposition) [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarStartEmergencyMode (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [bitte] ([den] Notfallmodus [(aktivieren | starten | einsschalten)] [bitte] | [(aktiviere | starte | schalte)] [bitte] [den] Notfallmodus [bitte] [ein] [(aktivieren | starten | einsschalten)] [bitte] [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarEndEmergencyMode (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [bitte] ([den] Notfallmodus [(deaktivieren | beenden | aussschalten)] [bitte] | [(deaktiviere | beende | schalte)] [bitte] [den] Notfallmodus [bitte] [aus] [(deaktivieren | beenden | aussschalten)] [bitte] [IDACO])","de"));
		return g;
	}
	...
	public static Grammar grammarHello (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Hallo | Guten (Tag | Morgen | [(Vor|Nach)]Mittag | Abend) | Grüß Gott | Servus) [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarBye (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[So [das wars | fertig]] [(Danke[schön] | Vielen Dank)] ([Auf] Wiedersehen | Tschüss | Ade)","de"));
		return g;
	}
	...
	public static Grammar grammarRequestStatus (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[Ist] [denn] [schon] alles ([vor]bereit[et] | fertig | so weit)","de"));
		return g;
	}
	...
	public static Grammar grammarAdoptPresets (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] (Übernimm [doch] [bitte] meine Voreinstellungen | Stell [doch] [bitte] (alle[s] | (die | alle) Geräte) auf (meine | die) [aktuellen] Voreinstellungen) [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarPatientInfo (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] ((Sag | Gib) [mir] [doch] [bitte] | Ich hätte gerne) [die] (Info(rmationen|s) über ((den | unseren) Patienten | (die | unsere) Patientin) | Patienteninfo(rmationen|s)) [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarMedication (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] ((Sag | Gib) [mir] [doch] [bitte] | Ich hätte gerne) [die] (Info(rmationen|s) über die (Medikation | medikamentöse [Vor]Behandlung) ((von unserem | unseres | des) Patienten | [von] (der | unserer) Patientin) | Medikamenteninfo(rmationen|s)) [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarLabData (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] [((Sag | Gib) [mir] [doch] [bitte] | Ich hätte gerne)] [die] (Labordaten | Daten aus dem Labor) [((von unserem | unseres | des) Patienten | [von] (der | unserer) Patientin)] [bitte] [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarStartOp (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[IDACO] ((Starte | Beginn | Fang) [doch] [bitte] (mit dem | den) Eingriff [an] | Lass uns [doch] [bitte] (mit dem | den) Eingriff (beginnen | starten | anfangen)) [IDACO]","de"));
		return g;
	}
	...
	public static Grammar grammarGas (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("([Bitte] Gas [einschalten] | Insufflator Start[en])","de"));
		return g;
	}
	...
	public static Grammar grammarTableRevTrendLightOff (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("([Jetzt] [bitte] [den] [OP]Tisch [jetzt] [bitte] [jetzt] (drehen | neigen | schief stellen | in Schieflage stellen) und [das] [Raum]Licht aus[schalten] [bitte] | "
				+ "[Bitte] [jetzt] [das] [Raum]Licht aus[schalten] und [den] [OP]Tisch (drehen | neigen | schief stellen | in Schieflage stellen) [bitte] | "
				+ "(Dreh | Neig[e] | Stell) [doch] [jetzt] [bitte] den [OP]Tisch [schief] und schalte das [Raum]Licht aus [bitte] | "
				+ "Schalte [doch] [bitte] [jetzt] das [Raum]Licht aus und (dreh | neig[e] | stell) den [OP]Tisch [schief] [bitte])","de"));
		return g;
	}
	...
	public static Grammar grammarCleanOptics (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[Optik] (Reinigen | Sauber machen)","de"));
		return g;
	}
	...
	public static Grammar grammarMoveOptics (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("Umsetzen [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarFocus (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[Bitte] [Kamera] (Mittig | Zentral | Fokussieren) [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarDistance (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[[(Mit der | Die)] Optik] [auf] Abstand [mit der Optik] [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarLightOn (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[Raum]Licht [an] [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarMoveGas (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("Gas umsetzen [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarSuction (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[Ab]saug[en] [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarClean (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("(Sauber machen | Reinigen) [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarMoveCameraToHilus (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("([(Jetzt | Nun)] [noch] [(am | der)] | Kamera zum) Hilus [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarMoveCameraToLiver (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[(Jetzt | Nun)] [noch] hinter der Leber [noch] [bitte]","de"));
		return g;
	}
	...
	public static Grammar grammarRemoveTrocars (OSFactory factory) {
		...
		g.addGrammarString(factory.factory.getOWLLiteral("[Die] Trokare [unter Sicht] (raus | entfernen) [bitte]","de"));
		return g;
	}
	...
	public static Utterance makeUtterance (OSFactory factory, String name) {
		...
		//Automatic device control
			...
			utterance_String = "Soll ich die Gas insufflation starten?";
			...
			utterance_String = "Die Gas insufflation muss nun manuell gestartet werden.";
		} else if (name.equals("utterance_RequestMaxGas")) {
			utterance_String = "Soll ich die Gas insufflation auf den Maximalwert steigern?";
		} else if (name.equals("utterance_GasAtMax")) {
			utterance_String = "Die Gas insufflation ist nun auf dem Maximum.";
...
//			utterance_String = "Der Solldruck von %varDB_dev_Insufflator_TargetPressure% mmHg wurde erreicht.";
			...
			utterance_String = "Ich habe die Gas insufflation wieder gestoppt.";
