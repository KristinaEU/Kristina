...
public class CambridgeRestaurantInfoNao {
		...
		public static Grammar prefixGrammarArea (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("[eat] [something] in the","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarRequestAreaName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("In which area is the restaurant","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarFood (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("(It | The food) (should be | needs to be | has to be)","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarRequestFoodName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("Which kind of food do I get in the restaurant","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("The name [of the restaurant] is | Its name is","en"));
			return g;
		}
		...
		public static Grammar GrammarRequestName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the name [of this restaurant]","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarPricerange (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("(It | The restaurant) (should be | needs to be | hast to be)","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarRequestPricerangeName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the pricerange of the restaurant","en"));
			return g;
		}
		...
		public static Grammar GrammarRequestPricerange (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the pricerange [of this restaurant]","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarRequestAddressName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the address of the restaurant","en"));
			return g;
		}
		...
		public static Grammar GrammarRequestAddress (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the address [of this restaurant]","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarRequestPhoneName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the phone number of the restaurant","en"));
			return g;
		}
		...
		//creates grammar for asking for the phone
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the phone number [of this restaurant]","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarRequestPostcodeName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the postcode of the restaurant","en"));
			return g;
		}
		...
		//creates grammar for asking for the postcode
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the postcode of this restaurant","en"));
			return g;
		}
		...
		public static Grammar prefixGrammarRequestSignatureName (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the signature of the restaurant","en"));
			return g;
		}
		...
		public static Grammar GrammarRequestSignature (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("the signature of this restaurant","en"));
			return g;
		}
		...
		public static Grammar grammarDeny (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("wrong | No | False | not right","en"));
			return g;
		}
		...
		public static Grammar grammarAffirm (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("correct | right | Yes","en"));
			return g;
		}
		...
		public static Grammar grammarRequestAlternative (OSFactory factory){
			...
			g.addGrammarString(factory.factory.getOWLLiteral("alternative","en")); 
			return g;
		}
...
//			}
        ...
        String filename = "camRestInfo.owl";
		...
		if (varName.hasDefaultValue()){
			varName.setDefaultValue(varName.getDefaultValue(), "Galleria"); //dummy
		}
		else {
			varName.setFirstDefaultValue("Galleria"); //dummy
		}
...
//		agendaTellArea.setVariableOperator("", "REQUIRES(%var_NeedArea%==yes");
		...
		agendaTellArea.setPriority(0, 180);
...
//		agendaTellFood.setVariableOperator("", "REQUIRES(%var_NeedFood%==yes)");
		...
		agendaTellFood.setPriority(0, 180);
...
//		agendaTellName.setPriority(0, 180);
...
//		agendaTellPricerange.setVariableOperator("", "REQUIRES(%var_NeedPricerange%==yes)");
		...
		agendaTellPricerange.setPriority(0, 180);
...
//		agendaTellAddress.setVariableOperator("", "REQUIRES(%var_NeedAddress%==yes)");
		...
		agendaTellAddress.setPriority(0, 180);
...
//		agendaTellPhone.setVariableOperator("", "REQUIRES(%var_NeedPhone%==yes)");
		...
		agendaTellPhone.setPriority(0, 180);
...
//		agendaTellPostcode.setVariableOperator("", "REQUIRES(%var_NeedPostcode%==yes)");
		...
		agendaTellPostcode.setPriority(0, 180);
...
//		agendaTellSignature.setVariableOperator("", "REQUIRES(%var_NeedSignature%==yes)");
		...
		agendaTellSignature.setPriority(0, 180);
...
//		agendaTellAlternative.setVariableOperator("", "REQUIRES(%var_NeedAlternative%==yes)"); 
		...
		agendaTellAlternative.setPriority(0, 180);
...
//		getAndAddUtterance(factory, moveSysTellName);
		...
		while (fileScannerNames.hasNextLine() == true) {
			...
			moveUserRequestAddressName.setVariableOperator("SET(" + varNeedAddress + "=yes)"); 
			...
			moveUserRequestPhoneName.setVariableOperator("SET(" + varNeedPhone + "=yes)");
			...
			moveUserRequestPostcodeName.setVariableOperator("SET(" + varNeedPostcode + "=yes)");
			...
			moveUserRequestSignatureName.setVariableOperator("SET(" + varNeedSignature + "=yes)");
			...
			moveUserRequestAreaName.setVariableOperator("SET(" + varNeedArea + "=yes)");
			...
			moveUserRequestFoodName.setVariableOperator("SET(" + varNeedFood + "=yes)");
			...
			moveUserRequestPricerangeName.setVariableOperator("SET(" + varNeedPricerange + "=yes)");
