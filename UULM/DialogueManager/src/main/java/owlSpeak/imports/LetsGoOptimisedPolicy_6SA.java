...
public class LetsGoOptimisedPolicy_6SA {
	...
	public static void main(String[] argv) throws Exception {
		...
		boolean confirmationMandatory = false;


		// Create Rewards
		Reward rewDefault = factory.createReward("rew_default");
		rewDefault.setRewardValue(-1); // bei IQReward -4, sonst -1
...
//		InteractionQuality.setDefaultValue("", "5");
		...
		// Create SummaryAgendas
		SummaryAgenda requestUserInitiative = factory.createSummaryAgenda("Request_UserInitiative_SumAgenda");
		requestUserInitiative.setRole(requestUserInitiative.getRole(), "collection");
		requestUserInitiative.setType(requestUserInitiative.getTypeString(), "request");
		
		SummaryAgenda requestSystemInitiative = factory.createSummaryAgenda("Request_SystemInitiative_SumAgenda");
		requestSystemInitiative.setRole(requestSystemInitiative.getRole(), "collection");
		requestSystemInitiative.setType(requestSystemInitiative.getTypeString(), "request");
		
		SummaryAgenda requestMixedInitiative = factory.createSummaryAgenda("Request_MixedInitiative_SumAgenda");
		requestMixedInitiative.setRole(requestMixedInitiative.getRole(), "collection");
		requestMixedInitiative.setType(requestMixedInitiative.getTypeString(), "request");

		SummaryAgenda confirmation = factory.createSummaryAgenda("Confirm_SumAgenda");
		...
		start.setType(start.getTypeString(), "request");
		...
		openAgenda.addSummaryAgenda(start);
		start.addSummarizedAgenda(openAgenda);
		...
		destAgenda.addSummaryAgenda(requestSystemInitiative);
		requestSystemInitiative.addSummarizedAgenda(destAgenda);
		...
		depAgenda.addSummaryAgenda(requestSystemInitiative);
		requestSystemInitiative.addSummarizedAgenda(depAgenda);
		...
		timeAgenda.addSummaryAgenda(requestSystemInitiative);
		requestSystemInitiative.addSummarizedAgenda(timeAgenda);
		...
		busAgenda.addSummaryAgenda(requestSystemInitiative);
		requestSystemInitiative.addSummarizedAgenda(busAgenda);
		...
		openAgenda_afterDep.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterDep);
		...
		openAgenda_afterDest.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterDest);
		...
		openAgenda_afterTime.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterTime);
		...
		openAgenda_afterBus.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterBus);
		...
		openAgenda_afterBusDep.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterBusDep);
		...
		openAgenda_afterBusDest.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterBusDest);
		...
		openAgenda_afterBusTime.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterBusTime);
		...
		openAgenda_afterTimeDep.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterTimeDep);
		...
		openAgenda_afterTimeDest.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterTimeDest);
		...
		openAgenda_afterDepDest.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterDepDest);
		...
		openAgenda_afterBusTimeDep.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterBusTimeDep);
		...
		openAgenda_afterBusTimeDest.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterBusTimeDest);
		...
		openAgenda_afterBusDepDest.addSummaryAgenda(requestUserInitiative);
		requestUserInitiative.addSummarizedAgenda(openAgenda_afterBusDepDest);
		...
		destAgendaWithoutDep.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaWithoutDep);
		...
		destAgendaWithoutTime.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaWithoutTime);
		...
		destAgendaWithoutBus.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaWithoutBus);
		...
		destAgendaWithoutTimeDep.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaWithoutTimeDep);
		...
		destAgendaWithoutBusDep.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaWithoutBusDep);
		...
		destAgendaWithoutBusTime.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaWithoutBusTime);
		...
		destAgendaWithoutBusTimeDep.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaWithoutBusTimeDep);
		...
		destAgendaAll.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(destAgendaAll);
		...
		depAgendaWithoutDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaWithoutDest);
		...
		depAgendaWithoutTime.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaWithoutTime);
		...
		depAgendaWithoutBus.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaWithoutBus);
		...
		depAgendaWithoutTimeDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaWithoutTimeDest);
		...
		depAgendaWithoutBusDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaWithoutBusDest);
		...
		depAgendaWithoutBusTime.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaWithoutBusTime);
		...
		depAgendaWithoutBusTimeDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaWithoutBusTimeDest);
		...
		depAgendaAll.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(depAgendaAll);
		...
		timeAgendaWithoutDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaWithoutDest);
		...
		timeAgendaWithoutDep.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaWithoutDep);
		...
		timeAgendaWithoutBus.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaWithoutBus);
		...
		timeAgendaWithoutDepDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaWithoutDepDest);
		...
		timeAgendaWithoutBusDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaWithoutBusDest);
		...
		timeAgendaWithoutBusDep.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaWithoutBusDep);
		...
		timeAgendaWithoutBusDepDest.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaWithoutBusDepDest);
		...
		timeAgendaAll.addSummaryAgenda(requestMixedInitiative);
		requestMixedInitiative.addSummarizedAgenda(timeAgendaAll);
