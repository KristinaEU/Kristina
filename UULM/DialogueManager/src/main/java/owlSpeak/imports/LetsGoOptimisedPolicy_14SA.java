...
public class LetsGoOptimisedPolicy_14SA {
...
//		InteractionQuality.setDefaultValue("", "5");
		...
		SummaryAgenda requestSystemInitiativeDestSummaryAgenda = factory.createSummaryAgenda("RequestSystemInitiative_Destination_SumAgenda");
		requestSystemInitiativeDestSummaryAgenda.setRole(requestSystemInitiativeDestSummaryAgenda.getRole(), "collection");
		requestSystemInitiativeDestSummaryAgenda.setType(requestSystemInitiativeDestSummaryAgenda.getTypeString(), "request");
		...
		destAgenda.addSummaryAgenda(requestSystemInitiativeDestSummaryAgenda);
		requestSystemInitiativeDestSummaryAgenda.addSummarizedAgenda(destAgenda);
		
		SummaryAgenda requestSystemInitiativeDepSummaryAgenda = factory.createSummaryAgenda("RequestSystemInitiative_Departure_place_SumAgenda");
		requestSystemInitiativeDepSummaryAgenda.setRole(requestSystemInitiativeDepSummaryAgenda.getRole(), "collection");
		requestSystemInitiativeDepSummaryAgenda.setType(requestSystemInitiativeDepSummaryAgenda.getTypeString(), "request");
		...
		depAgenda.addSummaryAgenda(requestSystemInitiativeDepSummaryAgenda);
		requestSystemInitiativeDepSummaryAgenda.addSummarizedAgenda(depAgenda);
		
		SummaryAgenda requestSystemInitiativeTimeSummaryAgenda = factory.createSummaryAgenda("RequestSystemInitiative_Time_SumAgenda");
		requestSystemInitiativeTimeSummaryAgenda.setRole(requestSystemInitiativeTimeSummaryAgenda.getRole(), "collection");
		requestSystemInitiativeTimeSummaryAgenda.setType(requestSystemInitiativeTimeSummaryAgenda.getTypeString(), "request");
		...
		timeAgenda.addSummaryAgenda(requestSystemInitiativeTimeSummaryAgenda);
		requestSystemInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgenda);
		
		SummaryAgenda requestSystemInitiativeBusSummaryAgenda = factory.createSummaryAgenda("RequestSystemInitiative_Bus_route_SumAgenda");
		requestSystemInitiativeBusSummaryAgenda.setRole(requestSystemInitiativeBusSummaryAgenda.getRole(), "collection");
		requestSystemInitiativeBusSummaryAgenda.setType(requestSystemInitiativeBusSummaryAgenda.getTypeString(), "request");
		...
		busAgenda.addSummaryAgenda(requestSystemInitiativeBusSummaryAgenda);
		requestSystemInitiativeBusSummaryAgenda.addSummarizedAgenda(busAgenda);
		
		
		// Create Agendas for the User Initiative
		SummaryAgenda requestUserInitiativeOpenSummaryAgenda = factory.createSummaryAgenda("RequestUserInitiative_Open_SumAgenda");
		requestUserInitiativeOpenSummaryAgenda.setRole(requestUserInitiativeOpenSummaryAgenda.getRole(), "collection");
		requestUserInitiativeOpenSummaryAgenda.setType(requestUserInitiativeOpenSummaryAgenda.getTypeString(), "request");
		...
		openAgenda_afterDep.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterDep);
		...
		openAgenda_afterDest.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterDest);
		...
		openAgenda_afterTime.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterTime);
		...
		openAgenda_afterBus.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterBus);
		...
		openAgenda_afterBusDep.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterBusDep);
		...
		openAgenda_afterBusDest.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterBusDest);
		...
		openAgenda_afterBusTime.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterBusTime);
		...
		openAgenda_afterTimeDep.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterTimeDep);
		...
		openAgenda_afterTimeDest.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterTimeDest);
		...
		openAgenda_afterDepDest.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterDepDest);
		...
		openAgenda_afterBusTimeDep.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterBusTimeDep);
		...
		openAgenda_afterBusTimeDest.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterBusTimeDest);
		...
		openAgenda_afterBusDepDest.addSummaryAgenda(requestUserInitiativeOpenSummaryAgenda);
		requestUserInitiativeOpenSummaryAgenda.addSummarizedAgenda(openAgenda_afterBusDepDest);
	
		
		// Create Agendas for the Mixed Initiative
		SummaryAgenda requestMixedInitiativeDestinationSummaryAgenda = factory.createSummaryAgenda("RequestMixedInitiative_Destination_SumAgenda");
		requestMixedInitiativeDestinationSummaryAgenda.setRole(requestMixedInitiativeDestinationSummaryAgenda.getRole(), "collection");
		requestMixedInitiativeDestinationSummaryAgenda.setType(requestMixedInitiativeDestinationSummaryAgenda.getTypeString(), "request");
		
		SummaryAgenda requestMixedInitiativeDepplaceSummaryAgenda = factory.createSummaryAgenda("RequestMixedInitiative_Depplace_SumAgenda");
		requestMixedInitiativeDepplaceSummaryAgenda.setRole(requestMixedInitiativeDepplaceSummaryAgenda.getRole(), "collection");
		requestMixedInitiativeDepplaceSummaryAgenda.setType(requestMixedInitiativeDepplaceSummaryAgenda.getTypeString(), "request");
		
		SummaryAgenda requestMixedInitiativeTimeSummaryAgenda = factory.createSummaryAgenda("RequestMixedInitiative_Time_SumAgenda");
		requestMixedInitiativeTimeSummaryAgenda.setRole(requestMixedInitiativeTimeSummaryAgenda.getRole(), "collection");
		requestMixedInitiativeTimeSummaryAgenda.setType(requestMixedInitiativeTimeSummaryAgenda.getTypeString(), "request");
		...
		destAgendaWithoutDep.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaWithoutDep);
		...
		destAgendaWithoutTime.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaWithoutTime);
		...
		destAgendaWithoutBus.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaWithoutBus);
		...
		destAgendaWithoutTimeDep.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaWithoutTimeDep);
		...
		destAgendaWithoutBusDep.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaWithoutBusDep);
		...
		destAgendaWithoutBusTime.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaWithoutBusTime);
		...
		destAgendaWithoutBusTimeDep.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaWithoutBusTimeDep);
		...
		destAgendaAll.addSummaryAgenda(requestMixedInitiativeDestinationSummaryAgenda);
		requestMixedInitiativeDestinationSummaryAgenda.addSummarizedAgenda(destAgendaAll);
		...
		depAgendaWithoutDest.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaWithoutDest);
		...
		depAgendaWithoutTime.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaWithoutTime);
		...
		depAgendaWithoutBus.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaWithoutBus);
		...
		depAgendaWithoutTimeDest.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaWithoutTimeDest);
		...
		depAgendaWithoutBusDest.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaWithoutBusDest);
		...
		depAgendaWithoutBusTime.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaWithoutBusTime);
		...
		depAgendaWithoutBusTimeDest.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaWithoutBusTimeDest);
		...
		depAgendaAll.addSummaryAgenda(requestMixedInitiativeDepplaceSummaryAgenda);
		requestMixedInitiativeDepplaceSummaryAgenda.addSummarizedAgenda(depAgendaAll);
		...
		timeAgendaWithoutDest.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaWithoutDest);
		...
		timeAgendaWithoutDep.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaWithoutDep);
		...
		timeAgendaWithoutBus.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaWithoutBus);
		...
		timeAgendaWithoutDepDest.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaWithoutDepDest);
		...
		timeAgendaWithoutBusDest.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaWithoutBusDest);
		...
		timeAgendaWithoutBusDep.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaWithoutBusDep);
		...
		timeAgendaWithoutBusDepDest.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaWithoutBusDepDest);
		...
		timeAgendaAll.addSummaryAgenda(requestMixedInitiativeTimeSummaryAgenda);
		requestMixedInitiativeTimeSummaryAgenda.addSummarizedAgenda(timeAgendaAll);
