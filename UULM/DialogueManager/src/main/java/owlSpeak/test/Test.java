...
public class Test {
	...
	public static void main (String[] argv) throws Exception {
		...
		try {
			factory = OwlSpeakOntology.createOSFactoryEmptyOnto("test.owl", Settings.homePath);
//			factory = createOSFactory("test.owl", "c:/OwlSpeak/", "OwlSpeakOnto.owl");
		...
		List <Grammar> GrammarList_spoken= new ArrayList<Grammar>();
		List <Grammar> GrammarList_unspoken= new ArrayList<Grammar>();
    	//Grammar g = factory.createGrammar("GrammarName");
		//g.addGrammarString(factory.factory.getOWLLiteral("GrammarString"));
		...
		// TODO Auto-generated method stub
		 //	File file2 = new File("C:\\Users\\Ahmed Ezzat\\Desktop\\lets_go\\intermediate_file.txt"); //Working
						...
						{	
							...
							if(first_char_QUESTION=='[') 
							{
						        ...
						        /// System.out.println("SPOKEN:"+rule); //rule-->public <Generic13>=[GoodEnough]; public <Generic14>=[No];file2_slot_number+question_2+"_"+".txt");
						 		...
						 		g1.addGrammarString(factory.factory.getOWLLiteral(rule));
						 		GrammarList_spoken.add(g1);
							}	
							...
							{	
				    			...
				    			//writeFile(rule,"D:\\workspace\\OwlSpeak\\src\\owlSpeak\\imports\\public_question_rules"+"_"+question_2+".txt");
				    			Grammar g2 = factory.createGrammar("public_question_rules"+"_"+question_2);
						 		g2.addGrammarString(factory.factory.getOWLLiteral(rule));
						 		GrammarList_spoken.add(g2);
							}	
						}
			...
			while (scan_file.hasNextLine())	
			{
				...
				slot.clear();
				Grammar g3 = factory.createGrammar("rule"+counter_unspoken);counter_unspoken++;
				...
				g3.addGrammarString(factory.factory.getOWLLiteral(temp_unspoken, "en"));
		 		...
		 		System.out.println(g3.getGrammarString().toString());
		 		GrammarList_unspoken.add(g3);
			}
			scan_file.close();
			boolean flag_3=file_3.delete(); // to delete the jsgf_unspoken
			System.out.println("HHHH="+flag_3);		
		System.out.println("number of sopken rules is: "+GrammarList_spoken.size());
		System.out.println("number of unspoken rules is: "+GrammarList_unspoken.size());
		System.out.println(GrammarList_spoken.get(0).getLocalName());
		System.out.println(GrammarList_spoken.get(1).getLocalName());
		System.out.println(GrammarList_spoken.get(2).getLocalName());
		System.out.println(GrammarList_spoken.get(3).getLocalName());
		System.out.println(GrammarList_spoken.get(40).getLocalName());

	//	System.out.println(GrammarList_unspoken.get(40).getFullName());
	///	System.out.println(GrammarList_unspoken.get(40).getLocalName());
	//	System.out.println(GrammarList_unspoken.get(40).toString());
	//	System.out.println(GrammarList_unspoken.get(40).getGrammarString());
