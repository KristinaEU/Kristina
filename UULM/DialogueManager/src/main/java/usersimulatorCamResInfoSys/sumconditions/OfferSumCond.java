...
public class OfferSumCond extends SummaryCondition {
	private Map<String, String> slots;

	public OfferSumCond(SummaryConditionType t) {
		super(t);
	...
	public void extractInformation(DialogueAct a) {
		if (a instanceof OfferDialogueAct) {
			OfferDialogueAct iDA = (OfferDialogueAct) a;
