...
public class CantHelpSumCond extends SummaryCondition {
	private Map<String, String> slots;

	public CantHelpSumCond(SummaryConditionType t) {
		super(t);
	...
	public void extractInformation(DialogueAct a) {
		if (a instanceof CantHelpDialogueAct) {
			CantHelpDialogueAct cDA = (CantHelpDialogueAct) a;
