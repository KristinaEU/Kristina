...
public class AffirmDialogueAct extends DialogueAct {
	private Map<String, String> slots;

	public AffirmDialogueAct(DialogueType t) {
		super(t);
	...
	public void mergeActs(DialogueAct d) {
		if(d instanceof AffirmDialogueAct){
			AffirmDialogueAct affirm = (AffirmDialogueAct) d;
			Vector<String> v = affirm.getSlots();
			for(String s: v)
				this.addSlotValue(s, affirm.getValue(s));
