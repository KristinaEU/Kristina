...
public class ConfirmDialogueAct extends DialogueAct {
	private Map<String, String> slots;

	public ConfirmDialogueAct(DialogueType t) {
		super(t);
	...
	public void mergeActs(DialogueAct d) {
		if(d instanceof ConfirmDialogueAct){
			ConfirmDialogueAct confirm = (ConfirmDialogueAct) d;
			Vector<String> v = confirm.getSlots();
			for(String s: v)
				this.addSlotValue(s, confirm.getValue(s));
