...
public class ReqaltsDialogueAct extends DialogueAct {
	private Map<String, String> slots;

	public ReqaltsDialogueAct(DialogueType t) {
		super(t);
	...
	public void mergeActs(DialogueAct d) {
		if(d instanceof ReqaltsDialogueAct){
			ReqaltsDialogueAct request = (ReqaltsDialogueAct) d;
			Vector<String> v = request.getSlots();
			for(String s: v)
				this.addSlotValue(s, request.getValue(s));
