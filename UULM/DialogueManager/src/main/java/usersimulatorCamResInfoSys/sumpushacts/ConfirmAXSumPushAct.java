...
public class ConfirmAXSumPushAct extends SummaryPushAction {
	private Map<String, String> slots;

	public ConfirmAXSumPushAct(double prob, SummaryPushActType t) {
		super(prob, t);
	...
	public void extractInformation(SummaryCondition sc,  UserGoal g) {
		...
		if (sc instanceof InformSumCond) {
			InformSumCond aSC = (InformSumCond) sc;
